...
#define NUM_EXTRUDER 1 // one is a normal j-head, the other the geetech all-metal hot end
...
// 101 is MAX6675
// 102 is MAX31855
#define EXT0_TEMPSENSOR_TYPE 98 // thermistor table 1 for 50 hotend with axial lead thermistor; thermistor table 2 for 35 hotend (original epcos thermistor); thermistor table 3 for 50 hotend with Semetic (weak lead) thermistor
...
*/
#define GENERIC_THERM1_BETA 3950 // 3974 looks to be the best option for the Honeywell 135-104LAC-J01 (axial lead thermistor in j-head)
...
#define GENERIC_THERM2_BETA 4092 // 4092 for epcos B57560G104F 25 / 100 (original on j-head)
...
#define GENERIC_THERM3_T0 25
#define GENERIC_THERM3_R0 100000
#define GENERIC_THERM3_BETA 3950 // 4267 for Semetic 104-GT2 thermistor (replacement for epcos B57560G104F in j-head)
#define GENERIC_THERM3_MIN_TEMP -20
#define GENERIC_THERM3_MAX_TEMP 300
#define GENERIC_THERM3_R1 0
#define GENERIC_THERM3_R2 10000
...
For MOST Delta, the following produce to-scale prints, but effector lifts at radius:
#define Z_MAX_LENGTH 247.0
#define DELTA_DIAGONAL_ROD 251
#define PRINTER_RADIUS 128
...
*/
#define DELTA_DIAGONAL_ROD 249.987 // mm
